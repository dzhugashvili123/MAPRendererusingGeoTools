...
public class SecondDraft {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String indiaShapefilePath = "src/main/Files/States/Admin2.shp"; // Path to India shapefile
...
//        SimpleFeatureSource locations2FeatureSource = locations2Store.getFeatureSource();
        ...
        mapRedo map = new mapRedo();
        MapLayerListListener myListener = new MapLayerListListener() {
            @Override
            ...
            public void layerPreDispose(MapLayerListEvent event) {
                System.out.println("!!!Layer predisposed!!!");
            }
        };
        map.addMapLayerListListener(myListener);
...
//        });
        ...
        // Display the map
        mapFrameRedo mapFrame = new mapFrameRedo(map);
